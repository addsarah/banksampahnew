...
<head>
  ...
  <!-- Favicons -->
  <link href="{{ asset("/frontend/assets/img/logo-only-website-bank-sampah.png") }}" rel="icon">
  <link href="{{ asset("/frontend/assets/img/logo-only-website-bank-sampah.png") }}" rel="apple-touch-icon">
  ...
  <header id="header" class="fixed-top d-flex align-items-center header-transparent">
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      ...
      <div class="logo me-auto">
        <h1><a href="{{ url("index.html") }}">Kumpulin</a></h1>
        <!-- Uncomment below if you prefer to use an image logo -->
        <!-- <a href="{{ url("index.html") }}"><img src="frontend/assets/img/logo.png" alt="" class="img-fluid"></a>-->
      </div>
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li class="dropdown"><a class="nav-link scrollto"href="{{ url("#menu") }}"><span>Kategori</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              <li><a href="{{ url("#menu") }}">Organik</a></li>
              <li><a href="{{ url("#menu") }}">Kertas</a></li>              
              <li><a href="{{ url("#menu") }}">Plastik</a></li>
              <li><a href="{{ url("#menu") }}">Barang Elektronik</a></li>
              <li><a href="{{ url("#menu") }}">Kaca</a></li>              
            </ul>
          </li>
      ...
      <a href="{{ route('login') }}" class="book-a-table-btn scrollto">Masuk</a>
      <a href="{{ route('register') }}" class="book-a-table-btn scrollto">Daftar</a>
    </div>
  </header><!-- End Header -->
    ...
    <div class="hero-container">
      <div id="heroCarousel" data-bs-interval="5000" class="carousel slide carousel-fade" data-bs-ride="carousel">
        ...
        <ol class="carousel-indicators" id="hero-carousel-indicators"></ol>
          <!-- Slide 1 -->
          <div class="carousel-item active col-lg-12 d-flex justify-content-center" style="background-image: url(frontend/assets/img/slide/slide-1.jpg);">
            <div class="carousel-container">
              <div class="carousel-content">
                ...
                <div>
                  <a href="{{ route('login') }}" class="btn-menu animate__animated animate__fadeInUp scrollto">Masuk</a>
                  <a href="{{ route('register') }}" class="btn-book animate__animated animate__fadeInUp scrollto">Daftar</a>
                </div>
              </div>
            </div>
          </div>
    ...
    <section id="about" class="about">
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <div class="col-lg-5 align-items-stretch video-box" style='background-image: url("frontend/assets/img/about.png");'>
            <a href="https://youtu.be/8KYX7LOVqAc" class="venobox play-btn mb-4" data-vbtype="video" data-autoplay="true"></a>
          </div>
        ...
        <div class="row g-0">
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item">
              <a href="{{ url("frontend/assets/img/gallery/gallery-1.jpg") }}" class="gallery-lightbox">
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item">
              <a href="{{ url("frontend/assets/img/gallery/gallery-2.jpg") }}" class="gallery-lightbox">
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item">
              <a href="{{ url("frontend/assets/img/gallery/gallery-3.jpg") }}" class="gallery-lightbox">
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item">
              <a href="{{ url("frontend/assets/img/gallery/gallery-4.jpg") }}" class="gallery-lightbox">
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item">
              <a href="{{ url("frontend/assets/img/gallery/gallery-5.jpg") }}" class="gallery-lightbox">
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item">
              <a href="{{ url("frontend/assets/img/gallery/gallery-6.jpg") }}" class="gallery-lightbox">
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item">
              <a href="{{ url("frontend/assets/img/gallery/gallery-7.jpg") }}" class="gallery-lightbox">
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item">
              <a href="{{ url("frontend/assets/img/gallery/gallery-8.jpg") }}" class="gallery-lightbox">
